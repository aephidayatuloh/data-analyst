...
**Trimmed mean** dihitung dengan menghilangkan persentase tertentu dari nilai-nilai tertinggi dan terendah dalam dataset sebelum menghitung rata-rata. Biasanya, proses ini dilakukan dengan menghapus nilai ekstrem dari kedua ujung distribusi (atas dan bawah) untuk meminimalkan pengaruh outlier.
...
Mengurangi Pengaruh Outlier, Trimmed mean mengurangi dampak nilai ekstrem yang bisa mempengaruhi rata-rata aritmetika secara signifikan.  
Memberikan Gambaran Lebih Stabil, Trimmed mean memberikan gambaran yang lebih stabil tentang pusat distribusi data, terutama dalam dataset yang mengandung outlier.

Kekurangan:

Menghilangkan Informasi, Dengan memangkas data, kita menghilangkan sebagian informasi yang mungkin masih relevan.  
Penentuan Persentase Pemangkasan, Menentukan persentase pemangkasan yang tepat bisa bersifat subjektif dan tergantung pada konteks data.

**Aplikasi**

Trimmed mean sering digunakan dalam situasi di mana data mengandung outlier yang dapat mempengaruhi hasil analisis. Misalnya, dalam analisis pendapatan rumah tangga, di mana beberapa individu mungkin memiliki pendapatan yang sangat tinggi atau sangat rendah dibandingkan dengan sebagian besar populasi, trimmed mean dapat memberikan gambaran yang lebih akurat tentang pendapatan tipikal.

Dalam penelitian ilmiah, trimmed mean juga digunakan untuk mengurangi pengaruh data yang tidak konsisten atau anomali yang dapat mengganggu hasil eksperimen. Dengan menggunakan trimmed mean, peneliti dapat memastikan bahwa analisis mereka lebih representatif dari data yang mayoritas, dan lebih sedikit terpengaruh oleh nilai ekstrem yang mungkin tidak mencerminkan pola umum.
